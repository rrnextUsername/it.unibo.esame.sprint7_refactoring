		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="handleAdd",cond=whenDispatch("fridge_handleAdd"))
					transition(edgeName="t031",targetState="handleRemove",cond=whenDispatch("fridge_handleRemove"))
					transition(edgeName="t032",targetState="handleQuery",cond=whenDispatch("fridge_handleQuery"))
					transition(edgeName="t033",targetState="handleExposeFood",cond=whenDispatch("fridge_handleExposeFood"))
				}	 
